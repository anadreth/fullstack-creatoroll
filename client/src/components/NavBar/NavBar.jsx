  ...
  return (
    <nav
      className={`font-poppins text-light ${
        contact ? "bg-transparent" : "bg-transparent"
      }  p-3 fixed w-full z-20 top-0 left-0 `}
    >
      <motion.div className="flex flex-wrap items-center justify-between mx-auto">
        <button onClick={toHome} className="flex items-center md:ml-6">
          ...
          />
          <span
            className={`font-seasons self-center text-xl ${
              contact ? "text" : "text-orange"
      ...
      <AnimatePresence>
        {show && (
          <motion.div
            className={`fixed rounded-lg flex justify-end items-start text-lg w-full h-screen p-3 mt-3 ${
              contact ? "bg-light text-red" : "bg-red text-light"
            }`}
            initial={{ x: "100%" }}
            animate={{ x: 0 }}
            exit={{ x: "100%" }}
          ...
          >
            <div className="w-full">
              <ul className="">
                <li>
                  <button
                    className="p-6  w-full hover:text-red hover:bg-light hover:font-bold text-end rounded-lg"
                    onClick={toHome}
                  >
                    HOME
                  </button>
