    ...
    <div>
        <footer className="p-3 m-3 bg-light sm:p-6  text-red font-poppins">
                ...
                <div className="grid  text-red grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-600 ">
                            <li className="mb-4">
                                <a href={urlHome} className="hover:underline">CreatoRoll</a>
                            </li>
                            <li>
                                <a href={urlHome + "documents"} className="hover:underline">Documents</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center">© 2023 <a href={urlHome} className="hover:underline">CreatoRoll™</a>. All Rights Reserved.
                </span>
