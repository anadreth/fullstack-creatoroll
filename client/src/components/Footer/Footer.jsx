    ...
    >
        <footer className="p-3 mx-3 mt-3 bg-light sm:p-6  text-red font-poppins">
                ...
                >
                    <div>
                        ...
                        <ul className="text-gray-600 ">
                            ...
                            <li>
                                <button onClick={() => navigate("/about")} className="hover:underline">Documents</button>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-gray-600 ">
                            ...
                            <li>
                                <a href="https://www.linkedin.com/in/miroslav-vano/"  target="_blank" className="hover:underline">LinkedIn</a>
                            </li>
                        </ul>
                    </div>
                    <div className=''>
                        ...
                        <ul className="text-gray-600 ">
                            ...
                            <li>
                                <button onClick={() => navigate("/about")} className="hover:underline text-left">Terms &amp; Conditions</button>
                            </li>
                        </ul>
                    </div>
                </motion.div>
            ...
            <motion.div className="sm:flex sm:items-center sm:justify-between"
                ...
                whileInView={{opacity: 1}}
            >
                <span className="text-sm text-gray-500 sm:text-center">© 2023 <button onClick={() => navigate("/about")} className="hover:underline">CreatoRoll™</button>. All Rights Reserved.
                </span>
