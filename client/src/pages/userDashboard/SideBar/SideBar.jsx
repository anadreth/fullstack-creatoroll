...
function SideBar({currentCharacters, setSelected, inspectCharacter, toInBetween}) {
  return (
    <div className={`bg-light h-screen max-w-[24rem] w-full flex flex-col justify-start items-stretch ${screen.width < 767 ? "mx-auto" : ""}`}>
        ...
        <div className='py-3 mt-auto'>
            ...
            onClick={toInBetween} className="bg-red w-full p-3 text-light shadow-md rounded-lg transition-all duration-150 hover:bg-orange hover:text-white"
            >
            Create New
            </motion.button>
        </div>
