...
function ChartLg({character, setBackPop, setClassPop, setEqpPop, setRacePop, setTraitPop}) {
  return (
    <div className="grid grid-cols-3 auto-rows-auto gap-3 h-full  w-full bg-white p-3 rounded-lg shadow-md text-red mb-3 overflow-scroll scrollbar-rounded-lg scrollbar-thin scrollbar-corner-red scrollbar-track-white scrollbar-thumb-red scrollbar-thumb-rounded-full scrollbar-track-rounded-full">
        <div className="col-span-1 row-span-2 bg-light rounded-lg shadow-md p-3">
        ...
        <div className="flex flex-col col-span-1 row-span-1 justify-between bg-light rounded-lg shadow-md p-3">
