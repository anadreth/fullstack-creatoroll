  ...
  const login = async (values, onSubmitProps) => {
    try {
      const loggedInResponse = await fetch(
        "https://creato-roll-server.onrender.com/auth/login",
        {
          method: "POST",
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col justify-center items-center">
                ...
                {isLogin && (
                  <div className="w-80 md:w-96 text-center">
                    <motion.h1
                      className="p-3 text-6xl font-seasons "
                      animate={{ opacity: [0, 1] }}
                ...
                <div className="w-80 flex justify-center items-center p-3">
                  <img
                    src="https://creato-roll-server.onrender.com/images/little-dice.png"
                ...
                >
                  {isLogin ? (
                    <>
                      <p className={`text-${!exist ? "orange" : "red"}`}>
                        {error
                          ? error
                          : exist
                      ...
                      <a
                        className={`underline cursor-pointer text-${
                          error ? "red" : !exist ? "orange" : "red"
                        }`}
                        onClick={() => {
                    ...
                    <>
                      <p
                        className={`text-${
                          error ? "orange" : duplicate ? "orange" : "red"
                        }`}
                      >
                        {error
                          ? error
                      ...
                      <a
                        className={`underline cursor-pointer text-${
                          error ? "red" : duplicate ? "orange" : "red"
                        }`}
                        onClick={() => {
                          setPageType(isLogin ? "register" : "login");
                          setError(null);
