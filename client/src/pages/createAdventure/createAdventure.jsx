    ...
    return (
        <div className="bg-light font-poppins">
            ...
            <div className="h-screen w-full flex flex-col justify-center items-center text-center ">
                ...
                <button className="inline-block active:animate-ping w-44 bg-white border-orange shadow-md text-orange border-2 p-3 mt-12" onClick={toInBetween}>Create Other</button>
            </div>
        </div>
    )
}
