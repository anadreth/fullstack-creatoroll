      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            ...
            element={isAuth ? <CreateCharacter /> : <Navigate to="/login" />}
          />
          <Route
            path="/create-adventure"
            element={isAuth ? <CreateAdventure /> : <Navigate to="/login" />}
          />
          <Route
            path="/create-in-between"
            element={isAuth ? <CreateInBetween /> : <Navigate to="/login" />}
          />
        </Routes>
      </BrowserRouter>
    </div>
